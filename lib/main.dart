    ...
    return MaterialApp(
      ...
      theme: ThemeData(useMaterial3: true, brightness: Brightness.light,
        colorScheme: ColorScheme.light(
          primary: Colors.pink[300]!, // Use a lighter shade of pink
          onPrimary: Colors.white, // Text color on primary color
          secondary: Colors.pink[200]!, // Lighter secondary color
          onSecondary: Colors.black, // Text color on secondary color
          background: Colors.pink[50]!, // Light background
          onBackground: Colors.black, // Text color on background
          surface: Colors.white, // Lighter surface color
